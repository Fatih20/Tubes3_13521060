...
function Chatbox() {
  ...
  return (
    <div className="flex flex-col w-full items-center justify-center bg-white py-4 px-4 gap-4 h-full">
      <ConversationBox />
      <div className="flex justify-start items-stretch gap-2 bg-secondary rounded-md p-2 h-fit w-full">
